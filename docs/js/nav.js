    ...
    navTarget.innerHTML = `
      <nav class="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-100">
        <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <!-- Logo -->
          <a href="index.html" class="flex items-center gap-2 text-xl font-bold text-gray-900 no-underline">
            <span class="text-2xl">🧞</span>
            <span>genie</span>
            <span class="text-xs font-normal text-gray-400 ml-1">by Stackgen</span>
          </a>
          ...
          <div class="hidden md:flex items-center gap-3">
            <a href="https://github.com/appcd-dev/genie" target="_blank" rel="noopener"
          ...
          <!-- Mobile Hamburger -->
          <button id="mobile-menu-btn" class="md:hidden p-2 text-gray-600 hover:text-gray-900" aria-label="Menu">
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="hidden md:hidden px-6 pb-4 space-y-3 bg-white border-b border-gray-100">
          ${navLink('index.html', 'Home')}
          ${navLink('docs.html', 'Docs')}
          ${navLink('config-builder.html', 'Config Builder')}
          ${navLink('chat.html', 'Chat')}
          ...
          <div class="pt-2 flex flex-col gap-2">
            <a href="https://github.com/appcd-dev/genie" target="_blank" rel="noopener"
               class="btn-secondary text-sm text-center no-underline">GitHub</a>
            <a href="https://stackgen.com" target="_blank" rel="noopener"
               class="btn-primary text-sm text-center no-underline">Try Stackgen</a>
          </div>
        </div>
      </nav>
    `;
        ...
        <div class="max-w-6xl mx-auto px-6 py-12">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div class="space-y-2">
                <a href="https://github.com/appcd-dev/genie" target="_blank" rel="noopener" class="block text-sm text-gray-500 hover:text-purple-600 no-underline">GitHub</a>
                <a href="https://github.com/appcd-dev/genie/issues" target="_blank" rel="noopener" class="block text-sm text-gray-500 hover:text-purple-600 no-underline">Issues</a>
