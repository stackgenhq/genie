...
2. Create and configure your Chat app in the [Google Chat API console](https://console.cloud.google.com/apis/api/chat.googleapis.com); set the app URL to your server's address.
