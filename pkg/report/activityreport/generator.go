...
// summary into the vector store so it is searchable like runbooks.
...
func buildSummary(events []audit.Event, since, until time.Time) string {
	...
	sb.WriteString("\n---\n*Generated by Genie activity report. Use this as a runbook/skill for future reference.*\n")
	return sb.String()
}
