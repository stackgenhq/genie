...
3. Genie sends a message to the chat: `⚠️ **Approval Required** ... Reply **Yes** to approve ... (or react with 👍 to approve / 👎 to reject)`
4. User replies: `Yes` (or `yes`, `Y`, `y`), or reacts with 👍 to approve

### Assert
1. Genie adds a ✅ reaction to the approval message (or replies with `✅ **Approved**` on platforms that do not support reactions).
